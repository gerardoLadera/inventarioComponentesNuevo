        ...
        <hr />
          <nav>
            <ul>
              ...
              <li>
                <Link to="/sgi/proveedores">
                  <LinkButton active={location.pathname === '/sgi/proveedores'} img={iconoProve}>
                    Proveedores
                  </LinkButton>
                </Link>
              </li>
              ...
              <li>
                <Link to="/sgi/movimientos">
                  <LinkButton active={location.pathname === '/sgi/movimientos'} img={iconoMovi}>
                    Movimientos
                  </LinkButton>
                </Link>
              </li>
